...
export default async () => {
  ...
  url.search=new URLSearchParams({select:'id,titulo,preco,imagem,url_curta',link_morto:'eq.false',url_curta:'not.is.null',order:'link_verificado_em.desc.nullslast',limit:'80'}).toString();
  try {
