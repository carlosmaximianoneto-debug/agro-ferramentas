...
Site responsivo em português, com trator animado e logo original no cabeçalho, catálogo real da tabela `produtos_agro_ferramentas`, links de afiliado e grupo de WhatsApp.
...
- `dist/app.js`: seleção de seis produtos e tratamento de indisponibilidade.
